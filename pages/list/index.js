...
function setup(das){
    ...
    //creating file with QR to the app
    file.writeText({
        uri: globalUri + "/" + "Android_app_link.txt",
        text: "https://mega.nz/file/LdNRxb5K#BuVKDMxvYT8D_3E-athguxaWZrSAvg4I1V-1PYEplFQ",
        success: function () {
            console.log("Created file with QR to android app");
            das.title = "Created file with QR to android app";
        },
        fail: function (data, code) {
            console.error("COULDN'T create file with QR to android app");
            das.title = globalUri + "/" + "Android_app_link.txt";
        },
    });
}
...
//internal://app/qr
///app/ace/data/com.adayup.QRCode/app/qr
